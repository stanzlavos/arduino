    ...
    if (client.connected()) {
      ...
      if (client.available() > 0) {
        ...
        switch(cmd)
        {
          ...
          case DEV_SPEAKER_OFF :
            turn_off_speaker();
            break;
        
          case DEV_SPEAKER_MUTE :
            speaker_mute();
            break;
      
          case DEV_SPEAKER_UNMUTE :
            speaker_unmute();
            break;
            
          case DEV_SPEAKER_VOL_UP :
            speaker_vol_up();
            break;
            
          case DEV_SPEAKER_VOL_DOWN :
            speaker_vol_down();
            break;
          
          case DEV_SPEAKER_VOL_MAX :
            speaker_vol_max();
            break;
            
          case DEV_SPEAKER_VOL_MIN :
            speaker_vol_min();
            break;
