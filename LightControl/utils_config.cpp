...
extern uint8_t on_time_hour;
extern uint8_t on_time_min;
extern uint8_t off_time_hour;
extern uint8_t off_time_min;
...
bool read_json_cfg(void)
{
  ...
  on_time_hour      =   root["light_time"]["on_time_hour"];
  on_time_min       =   root["light_time"]["on_time_min"];
  off_time_hour     =   root["light_time"]["off_time_hour"];
  off_time_min      =   root["light_time"]["off_time_min"];
